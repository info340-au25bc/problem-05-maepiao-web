...
let num = (newMottoLength/mottoLength)*100;
let ratio = num.toFixed(2);
console.log(ratio+"%");
...
let median = numbers[Math.floor(arrayLength/2)];
console.log(median);
...
let xCoordinate = rect.x;
let yCoordinate = rect.y;
